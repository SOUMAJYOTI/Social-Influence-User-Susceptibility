...
public class Cons {
	...
	public static Double[][] cMatrixTrust = null; //C matrix based on trust of neighbors
	...
	public static Double eta = .0; // for ensemble probability model in the factor
	//end of control parameters
	
	//others
	public static String trainDatFile = "";
	public static String diffDatFile = "";
	...
	//Neighbor weights
	public static Map<Integer, Map<Integer, Integer>> nbrWeights = new HashMap<Integer, Map<Integer, Integer>>();
